...
\begin{tikzpicture}[tdplot_main_coords]
	...
	\coordinate(7) at (\escala*0.5, \escala*1.20711, -\escala*1.20711);
	\coordinate(8) at (\escala*0.5, \escala*1.20711, \escala*1.20711);
	\coordinate(9) at (\escala*0.5, -\escala*1.20711, -\escala*1.20711);
	\coordinate(10) at (\escala*0.5, -\escala*1.20711, \escala*1.20711);
	%
	\coordinate(11) at (-\escala*0.707107, \escala*0., \escala*1.91421);
	\coordinate(12) at (\escala*0.707107, \escala*0., \escala*1.91421);
	\coordinate(13) at (\escala*1.20711, -\escala*0.5, -\escala*1.20711);
	\coordinate(14) at (\escala*1.20711, -\escala*0.5, \escala*1.20711);
	\coordinate(15) at (\escala*1.20711, \escala*0.5, -\escala*1.20711);
	\coordinate(16) at (\escala*1.20711, \escala*0.5, \escala*1.20711);
	\coordinate(17) at (\escala*1.20711, \escala*1.20711, -\escala*0.5);
	\coordinate(18) at (\escala*1.20711, \escala*1.20711, \escala*0.5);
	\coordinate(19) at (\escala*1.20711, -\escala*1.20711, -\escala*0.5);
	\coordinate(20) at (\escala*1.20711, -\escala*1.20711, \escala*0.5);
	%
	\coordinate(21) at (-\escala*1.20711, -\escala*0.5, -\escala*1.20711);
	\coordinate(22) at (-\escala*1.20711, -\escala*0.5, \escala*1.20711);
	\coordinate(23) at (-\escala*1.20711, \escala*0.5, -\escala*1.20711);
	\coordinate(24) at (-\escala*1.20711, \escala*0.5, \escala*1.20711);
	\coordinate(25) at (-\escala*1.20711, \escala*1.20711, -\escala*0.5);
	\coordinate(26) at (-\escala*1.20711, \escala*1.20711, \escala*0.5);
	\coordinate(27) at (-\escala*1.20711, -\escala*1.20711, -\escala*0.5);
	\coordinate(28) at (-\escala*1.20711, -\escala*1.20711, \escala*0.5);
