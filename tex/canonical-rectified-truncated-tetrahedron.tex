...
\begin{tikzpicture}[tdplot_main_coords]
	...
	\coordinate(0) at (\escala * 0.0, \escala * 0.0, \escala * \dos);
	\coordinate(1) at (\escala * 0.0, \escala * 0.0, -\escala * \dos);
	\coordinate(2) at (\escala * \dos, \escala * 0.0, \escala * 0.0);
	\coordinate(3) at (-\escala * \dos, \escala * 0.0, \escala * 0.0);
	\coordinate(4) at (\escala * 0.0, \escala * \dos, \escala * 0.0);
	\coordinate(5) at (\escala * 0.0, -\escala * \dos, \escala * 0.0);
	\coordinate(6) at (\escala * \uno, -\escala * \cero, \escala * \uno);
	\coordinate(7) at (\escala * \uno, \escala * \cero, -\escala * \uno);
	\coordinate(8) at (-\escala * \uno, \escala * \cero, \escala * \uno);
	\coordinate(9) at (-\escala * \uno, -\escala * \cero, -\escala * \uno);
	\coordinate(10) at (\escala * \uno, -\escala * \uno, \escala * \cero);
	\coordinate(11) at (\escala * \uno, \escala * \uno, -\escala * \cero);
	\coordinate(12) at (-\escala * \uno, \escala * \uno, \escala * \cero);
	\coordinate(13) at (-\escala * \uno, -\escala * \uno, -\escala * \cero);
	\coordinate(14) at (\escala * \cero, -\escala * \uno, \escala * \uno);
	\coordinate(15) at (\escala * \cero, \escala * \uno, -\escala * \uno);
	\coordinate(16) at (-\escala * \cero, \escala * \uno, \escala * \uno);
	\coordinate(17) at (-\escala * \cero, -\escala * \uno, -\escala * \uno);
