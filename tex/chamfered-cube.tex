...
\begin{tikzpicture}[tdplot_main_coords,scale=1.25]
	...
	\coordinate(0) at (0.5, 0.5, \uno);
	\coordinate(1) at (0.5, 0.5, -\uno);
	\coordinate(2) at (0.5, -0.5, \uno);
	\coordinate(3) at (0.5, -0.5, -\uno);
	\coordinate(4) at (-0.5, 0.5, \uno);
	\coordinate(5) at (-0.5, 0.5, -\uno);
	\coordinate(6) at (-0.5, -0.5, \uno);
	\coordinate(7) at (-0.5, -0.5, -\uno);
	\coordinate(8) at (\uno, 0.5, 0.5);
	\coordinate(9) at (\uno, 0.5, -0.5);
	\coordinate(10) at (\uno, -0.5, 0.5);
	%
	\coordinate(11) at (\uno, -0.5, -0.5);
	\coordinate(12) at (-\uno, 0.5, 0.5);
	\coordinate(13) at (-\uno, 0.5, -0.5);
	\coordinate(14) at (-\uno, -0.5, 0.5);
	\coordinate(15) at (-\uno, -0.5, -0.5);
	\coordinate(16) at (0.5, \uno, 0.5);
	\coordinate(17) at (0.5, \uno, -0.5);
	\coordinate(18) at (0.5, -\uno, 0.5);
	\coordinate(19) at (0.5, -\uno, -0.5);
	\coordinate(20) at (-0.5, \uno, 0.5);
	%
	\coordinate(21) at (-0.5, \uno, -0.5);
	\coordinate(22) at (-0.5, -\uno, 0.5);
	\coordinate(23) at (-0.5, -\uno, -0.5);
	\coordinate(24) at (\cero, \cero, \cero);
	\coordinate(25) at (\cero, \cero, -\cero);
	\coordinate(26) at (\cero, -\cero, \cero);
	\coordinate(27) at (\cero, -\cero, -\cero);
	\coordinate(28) at (-\cero, \cero, \cero);
	\coordinate(29) at (-\cero, \cero, -\cero);
	\coordinate(30) at (-\cero, -\cero, \cero);
	%
	\coordinate(31) at (-\cero, -\cero, -\cero);
