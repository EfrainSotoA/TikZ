...
%
\begin{tikzpicture}[tdplot_main_coords,scale=4.0]
	% Coordinates of the vertices
	\coordinate(1) at (-0.5, 0., 0.);
	\coordinate(2) at (0., -0.5, 1.56786);
	\coordinate(3) at (0., 0.5, 1.56786);
	\coordinate(4) at (0., -0.644584, 0.578369);
	\coordinate(5) at (0., 0.644584, 0.578369);
	\coordinate(6) at (0.5, 0., 0.);
	\coordinate(7) at (-0.644584, 0., 0.989492);
	\coordinate(8) at (0.644584, 0., 0.989492);
